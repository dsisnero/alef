...
static TEMPLATES: &[(&str, &str)] = &[
    ("lib_header.jinja", include_str!("templates/lib_header.jinja")),
    ("lib_fun.jinja", include_str!("templates/lib_fun.jinja")),
    ("module_header.jinja", include_str!("templates/module_header.jinja")),
    ("shard.yml.jinja", include_str!("templates/shard.yml.jinja")),
];
